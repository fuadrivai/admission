...
Route::group(['middleware' => 'prevent-back-history'], function () {
    ...
    Route::post('uniform/{uniform}/pickup', [UniformController::class, 'confirmPickup'])->name('uniform.confirm');
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::prefix('schoolvisit')->name('schoolvisit.')->group(function () {
            ...
            Route::post('delete/many', [SchoolVisitController::class, 'deleteMany'])->name('schoolvisit.deleteMany');
        ...
        Route::prefix('applicant')->name('applicant.')->group(function () {
            Route::get('enrolment/{id}', [AdmissionController::class, 'viewEnrolment'])->name('viewEnrolment');
