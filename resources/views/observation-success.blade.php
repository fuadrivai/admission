...
<head>
    ...
    <title>Observasi Berhasil</title>
    ...
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 90vh;">
        <div class="col-md-8 col-lg-6">
            <div class="success-card">
                ...
                <h2 class="success-title">Observasi Berhasil!</h2>
                <p class="success-text">
                    Terima kasih telah mengisi form observasi. <br>
                    Detail lengkap observasi sudah kami kirimkan ke email Anda. <br>
                ...
                <div class="support-text">
                    Belum menerima email? Periksa folder <strong>Spam</strong> atau hubungi kami di
