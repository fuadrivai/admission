...
<head>
    ...
    <title>Uniform Receipt - Mutiara Harapan Islamic School</title>
    <style>
        body {
            ...
            <table class="header-table">
                <tr>
                    ...
                    <td class="header-right">
                        <h1 class="invoice-title">Uniform Receipt</h1>
            ...
            <table class="invoice-table">
                ...
                <tbody>
                    @if(isset($items) && is_array($items) && count($items) > 0)
                        ...
                        <tr>
                            <td>{{ $item['product_name'] ?? 'Uniform Item' }}</td>
                            <td>{{ $item['size'] ?? '-' }}</td>
                            <td>{{ $item['qty'] ?? 1 }}</td>
                            <td class="amount">Rp {{ number_format($item['subtotal'] ?? 0, 0, ',', '.') }}</td>
                        </tr>
                        @endforeach
                    @else
                        <tr>
        ...
        <div class="section">
            ...
            <div class="description-box">
                <div class="description-content">
                    <p>
                        1. This receipt serves as proof of payment for uniform purchase at Mutiara Harapan Islamic School.
                    </p>
                    <p>
                        2. Payments are
