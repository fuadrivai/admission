...
return [
    'step1' => [
        'title'  => 'Authorized Signatory Confirmation',
        'labels'=>[
            'text0'=>[
                'english'=>'Relationship to Student (select one):',
                'indonesian'=>'Relationship to Student (select one):',
            ],
            'text1'=>[
                'english'=>'Parent Information',
                'indonesian'=>'Parent Information :',
            ],
            'text2'=>[
                'english'=>'Full name',
                'indonesian'=>'',
    ...
    'step2' => [
        'title'  => 'School Fee Payment Consent Form',
        'labels'=>[
            'text1'=>[
                'english'=>'I hereby state that I fully agree to all applicable payment terms and procedures and undertake to fulfil all payment obligations in accordance with the regulations of Mutiara Harapan Islamic School.',
                'indonesian'=>'Dengan ini saya menyatakan bahwa saya menyetujui sepenuhnya seluruh ketentuan dan tata cara pembayaran yang berlaku serta bersedia memenuhi dan melaksanakan seluruh kewajiban pembayaran sesuai dengan ketentuan Mutiara Harapan Islamic School.',
            ],
            'text2'=>[
                'english'=>'Development Fee',
                'indonesian'=>'',
            ],
            'text3'=>[
                'english'=>'Annual Fee',
            ...
            'text5'=>[
                'english'=>'I hereby declare that I fully agree to the following payment terms and conditions',
                'indonesian'=>'',
            ],
            'text6'=>[
                'english'=>'The Development Fee shall be paid in accordance with the applicable regulations at the time of new student enrolment at Mutiara Harapan Islamic School.',
                'indonesian'=>'Development fee akan Saya bayar sesuai dengan ketentuan yang berlaku pada saat pendaftaran siswa baru Mutiara Harapan Islamic School.',
            ],
            'text7'=>[
                'english'=>'The Annual Fee and School Fee shall be paid upon my child being officially accepted at Mutiara Harapan Islamic School.',
                'indonesian'=>'Annual fee dan school fee akan Saya bayar pada saat putra/putri Saya dinyatakan diterima di Mutiara Harapan Islamic School.',
            ],
            'text8'=>[
                'english'=>'International Examination Fees, which are mandatory, shall be determined at the time the examination is conducted.',
            ...
            'text10'=>[
                ...
                'indonesian'=>'Biaya ekstrakurikuler sesuai dengan yang dipilih putra/putri Saya.',
            ],
            'text11'=>[
                'english'=>'Other Activity Fees shall be charged based on the nature and timing of the activities conducted.',
                'indonesian'=>'Biaya kegiatan lainnya yang besarnya ditetapkan pada saat akan dilaksanakan.',
            ],
            'text12'=>[
                'english'=>'The School Fee shall be paid no later than the 10th day of each month.',
                'indonesian'=>'School fee Saya bayarkan paling lambat tanggal 10 bulan berjalan.',
            ],
            'text13'=>[
                'english'=>'The Ittihada Fee, the amount of which shall be determined by Ittihada, shall be paid on an annual basis.',
            ...
            'text15'=>[
                'english'=>'I further acknowledge and agree that:',
                'indonesian'=>'Selanjutnya saya juga menyatakan Setuju/Sepakat bahwa:',
            ],
            'text16'=>[
                'english'=>'The Annual Fee may be adjusted every two (2) years.',
                'indonesian'=>'Annual fee akan ada penyesuaian setiap 2 tahun',
            ],
            'text17'=>[
                'english'=>'The School Fee shall be determined by school policy and may be adjusted every three (3) years.',
                'indonesian'=>'School fee akan ada penyeseuaian setiap 3 tahun',
            ],
            'text18'=>[
                'english'=>'Any Development Fee, Annual Fee, and School Fee that has been paid is non-refundable and non-transferable, except in the event that my child is officially declared not accepted at Mutiara Harapan Islamic School.',
                'indonesian'=>'Development fee, annual fee dan school fee yang sudah Saya bayar tidak akan Saya tarik kembali atau Saya alihkan dengan alasan apapun, kecuali putra/putri Saya dinyatakan tidak diterima di Mutiara Harapan Islamic School.',
            ],
            'text19'=>[
                'english'=>'Academic evaluation results may not be released if all administrative obligations have not been fulfilled.',
                'indonesian'=>'Saya tidak dapat mengambil hasil evaluasi belajar putra/putri Saya sebelum Saya memenuhi seluruh kewajiban Administrasi yang ditetapkan MHIS.',
            ],
            'text20'=>[
                'english'=>'I agree to submit all required supporting documents prior to the commencement of academic activities.',
                'indonesian'=>'Saya menyetujui untuk menyerahkan seluruh dokumen pendukung yang dipersyaratkan sebelum dimulainya kegiatan akademik.',
            ],
            'text21'=>[
    ...
    'step4' => [
        ...
        'labels'=>[
            'text1'=>[
                ...
                'indonesian'=>'Dengan ini menyatakan bersedia mengikuti sosialisasi orang tua peserta didik baru sesuai dengan waktu yang akan ditetapkan kemudian.',
            ],
            'text2'=>[
                'english'=>'I hereby declare that this statement form is agreed upon by me consciously without any pressure from any party.',
                'indonesian'=>'Demikian form pernyataan ini Saya sepakati secara sadar tanpa ada tekanan dari pihak manapun.',
            ],
            'text3'=>[
                'english'=>'Form Completion',
    ...
    'step5' => [
        ...
        'labels'=>[
            ...
            'text8'=>[
                'english'=>'Student Information',
                'indonesian'=>'Informasi Calon Siswa',
            ],
            'text9'=>[
                'english'=>'Full Name',
                'indonesian'=>'Nama Lengkap',
